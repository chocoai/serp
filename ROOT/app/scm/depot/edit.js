var api = frameElement.api,oper = api.data.oper,id=api.data.rowId,$_form=$("#base_form"),addNew=false;
...
function postData(){
	var e = "add" == oper ? "新增仓库" : "修改仓库";
	Public.ajaxPost(rootPath+"/scm/depot/save.json",model.data.$model//$_form.serialize()
			, function(t) {
		if (200 == t.status) {
